...
class FirstViewController: UIViewController {
	...
	var categories: [Category] = [
		Category(name: "Фитнес и SPA", imageName: "dumbbell.fill", expense: 12023, bonus: 0, color: UIColor(named: "red")!),
		Category(name: "Такси", imageName: "car.circle.fill", expense: 23214, bonus: 0, color: UIColor(named: "orange")!),
		Category(name: "Салоны красоты и косметики", imageName: "sparkles", expense: 12992, bonus: 0, color: UIColor(named: "yellow")!),
		Category(name: "Кафе и рестораны", imageName: "fork.knife.circle.fill", expense: 44121, bonus: 0, color: UIColor(named: "mellon")!),
		Category(name: "Медицинские услуги", imageName: "pills.circle.fill", expense: 10023, bonus: 0, color: UIColor(named: "salad")!),
		Category(name: "Онлайн кино и музыка", imageName: "music.note.tv.fill", expense: 5933, bonus: 0, color: UIColor(named: "azure")!),
		Category(name: "Одежда и обувь", imageName: "bag.fill", expense: 65212, bonus: 0, color: UIColor(named: "blue")!),
		Category(name: "Игровые сервисы", imageName: "gamecontroller.fill", expense: 6432, bonus: 0, color: UIColor(named: "berry")!),
		Category(name: "Путешествия", imageName: "airplane.circle.fill",
				 expense: 14999, bonus: 0, color: UIColor(named: "purple")!),
		Category(name: "Мебель", imageName: "chair.lounge.fill", expense: 12324, bonus: 0, color: UIColor(named: "corall")!),
		Category(name: "Другое", imageName: "rays", expense: 31321, bonus: 0, color: .systemGray3)
